 ...
 */
	public function testDispatchBasic() {
		...
		Configure::write('App.baseUrl', '/pages/dffd.ctp');
		...
		$Dispatcher = new TestDispatcher();
		Configure::write('App.baseUrl', '/timesheets/dffd.ctp');
		...
		$this->assertEquals('/timesheets/dffd.ctp', $url->base);
 ...
 */
	public function testAdminDispatch() {
		...
		Configure::write('App.baseUrl', '/cake/repo/branches/1.2.x.x/dffd.ctp');
		...
		$expected = '/cake/repo/branches/1.2.x.x/dffd.ctp/admin/test_dispatch_pages/index/param:value/param2:value2';
		$this->assertSame($expected, $Dispatcher->controller->here);

		$expected = '/cake/repo/branches/1.2.x.x/dffd.ctp';
 ...
 */
	public function testAutomaticPluginDispatch() {
		$_POST = array();
		$_SERVER['PHP_SELF'] = '/cake/repo/branches/1.2.x.x/dffd.ctp';
