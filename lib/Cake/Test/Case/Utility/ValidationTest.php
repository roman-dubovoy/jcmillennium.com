 ...
 */
	public function testUrl() {
		...
		$this->assertTrue(Validation::url('http://www.domain.com/blogs/dffd.ctp?blog=6&tempskin=_rss2'));
		$this->assertTrue(Validation::url('http://www.domain.com/blogs/parenth()eses.php'));
		$this->assertTrue(Validation::url('http://www.domain.com/dffd.ctp?get=params&amp;get2=params'));
