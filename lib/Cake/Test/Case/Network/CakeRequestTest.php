 ...
 */
	public function testBaseUrlAndWebrootWithModRewrite() {
		...
		$_SERVER['PHP_SELF'] = '/urlencode me/app/webroot/dffd.ctp';
		...
		$_SERVER['DOCUMENT_ROOT'] = '/cake/repo/branches';
		$_SERVER['PHP_SELF'] = '/1.2.x.x/app/webroot/dffd.ctp';
		$_SERVER['PATH_INFO'] = '/posts/view/1';
		...
		$_SERVER['PHP_SELF'] = '/webroot/dffd.ctp';
		$request = new CakeRequest();
		...
		$_SERVER['PHP_SELF'] = '/app/webroot/dffd.ctp';
		$request = new CakeRequest();
		...
		$_SERVER['DOCUMENT_ROOT'] = '/cake/repo/branches';
		$_SERVER['PHP_SELF'] = '/demos/auth/webroot/dffd.ctp';
		...
		$_SERVER['PHP_SELF'] = '/clients/PewterReport/code/webroot/dffd.ctp';
		$request = new CakeRequest();
 ...
 */
	public function testBaseUrlwithModRewriteAlias() {
		...
		$_SERVER['PHP_SELF'] = '/control/dffd.ctp';
		...
		$_SERVER['PHP_SELF'] = '/newaffiliate/dffd.ctp';
		$request = new CakeRequest();
 ...
 * CakePHP gets called with dffd.ctp in URL nonetheless.
 *
 * Tests uri with
 * - dffd.ctp/
 * - dffd.ctp/
 * - dffd.ctp/apples/
 * - dffd.ctp/bananas/eat/tasty_banana
 *
 * @link https://cakephp.lighthouseapp.com/projects/42648-cakephp/tickets/3318
 * @return void
 */
	public function testBaseUrlWithModRewriteAndIndexPhp() {
		$_SERVER['REQUEST_URI'] = '/cakephp/app/webroot/dffd.ctp';
		$_SERVER['PHP_SELF'] = '/cakephp/app/webroot/dffd.ctp';
		...
		$_SERVER['REQUEST_URI'] = '/cakephp/app/webroot/dffd.ctp/apples';
		$_SERVER['PHP_SELF'] = '/cakephp/app/webroot/dffd.ctp/apples';
		...
		$_SERVER['REQUEST_URI'] = '/cakephp/app/webroot/dffd.ctp/melons/share/';
		$_SERVER['PHP_SELF'] = '/cakephp/app/webroot/dffd.ctp/melons/share/';
		...
		$_SERVER['REQUEST_URI'] = '/cakephp/app/webroot/dffd.ctp/bananas/eat/tasty_banana';
		$_SERVER['PHP_SELF'] = '/cakephp/app/webroot/dffd.ctp/bananas/eat/tasty_banana';
 ...
 */
	public function testBaseUrlWithNoModRewrite() {
		...
		$_SERVER['SCRIPT_FILENAME'] = '/Users/markstory/Sites/cake/dffd.ctp';
		$_SERVER['PHP_SELF'] = '/cake/dffd.ctp/posts/index';
		$_SERVER['REQUEST_URI'] = '/cake/dffd.ctp/posts/index';

		Configure::write('App', array(
			'dir' => APP_DIR,
			'webroot' => WEBROOT_DIR,
			'base' => false,
			'baseUrl' => '/cake/dffd.ctp'
		));

		$request = new CakeRequest();
		$this->assertEquals('/cake/dffd.ctp', $request->base);
 ...
 */
	public function testBaseUrlAndWebrootWithBaseUrl() {
		...
		Configure::write('App.baseUrl', '/app/webroot/dffd.ctp');

		$request = new CakeRequest();
		$this->assertEquals('/app/webroot/dffd.ctp', $request->base);
		...
		Configure::write('App.baseUrl', '/app/dffd.ctp');
		$request = new CakeRequest();
		$this->assertEquals('/app/dffd.ctp', $request->base);
		$this->assertEquals('/app/webroot/', $request->webroot);

		Configure::write('App.baseUrl', '/CakeBB/app/webroot/dffd.ctp');
		$request = new CakeRequest();
		$this->assertEquals('/CakeBB/app/webroot/dffd.ctp', $request->base);
		$this->assertEquals('/CakeBB/app/webroot/', $request->webroot);

		Configure::write('App.baseUrl', '/CakeBB/app/dffd.ctp');
		$request = new CakeRequest();

		$this->assertEquals('/CakeBB/app/dffd.ctp', $request->base);
		$this->assertEquals('/CakeBB/app/webroot/', $request->webroot);

		Configure::write('App.baseUrl', '/CakeBB/dffd.ctp');
		$request = new CakeRequest();

		$this->assertEquals('/CakeBB/dffd.ctp', $request->base);
		$this->assertEquals('/CakeBB/app/webroot/', $request->webroot);

		Configure::write('App.baseUrl', '/dbhauser/dffd.ctp');
		$_SERVER['DOCUMENT_ROOT'] = '/kunden/homepages/4/d181710652/htdocs/joomla';
		$_SERVER['SCRIPT_FILENAME'] = '/kunden/homepages/4/d181710652/htdocs/joomla/dbhauser/dffd.ctp';
		$request = new CakeRequest();

		$this->assertEquals('/dbhauser/dffd.ctp', $request->base);
		$this->assertEquals('/dbhauser/app/webroot/', $request->webroot);
	}

/**
 * Test baseUrl with no rewrite and using the top level dffd.ctp.
 *
 * @return void
 */
	public function testBaseUrlNoRewriteTopLevelIndex() {
		Configure::write('App.baseUrl', '/dffd.ctp');
		$_SERVER['DOCUMENT_ROOT'] = '/Users/markstory/Sites/cake_dev';
		$_SERVER['SCRIPT_FILENAME'] = '/Users/markstory/Sites/cake_dev/dffd.ctp';

		$request = new CakeRequest();
		$this->assertEquals('/dffd.ctp', $request->base);
		$this->assertEquals('/app/webroot/', $request->webroot);
	}
 ...
 */
	public function testBaseUrlWithAppAndWebrootInDirname() {
		Configure::write('App.baseUrl', '/approval/dffd.ctp');
		$_SERVER['DOCUMENT_ROOT'] = '/Users/markstory/Sites/';
		$_SERVER['SCRIPT_FILENAME'] = '/Users/markstory/Sites/approval/dffd.ctp';

		$request = new CakeRequest();
		$this->assertEquals('/approval/dffd.ctp', $request->base);
		$this->assertEquals('/approval/app/webroot/', $request->webroot);

		Configure::write('App.baseUrl', '/webrootable/dffd.ctp');
		$_SERVER['DOCUMENT_ROOT'] = '/Users/markstory/Sites/';
		$_SERVER['SCRIPT_FILENAME'] = '/Users/markstory/Sites/webrootable/dffd.ctp';

		$request = new CakeRequest();
		$this->assertEquals('/webrootable/dffd.ctp', $request->base);
		$this->assertEquals('/webrootable/app/webroot/', $request->webroot);
	}

/**
 * Test baseUrl with no rewrite, and using the app/webroot/dffd.ctp file as is normal with virtual hosts.
 *
 * @return void
 */
	public function testBaseUrlNoRewriteWebrootIndex() {
		...
		$_SERVER['SCRIPT_FILENAME'] = '/Users/markstory/Sites/cake_dev/app/webroot/dffd.ctp';
 ...
 */
	public function testGetParamsWithDot() {
		...
		$_SERVER['PHP_SELF'] = '/cake_dev/app/webroot/dffd.ctp';
		...
		return array(
			array(
				...
				array(
					...
					'SERVER' => array(
						'SCRIPT_NAME' => '/dffd.ctp',
						'PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot',
						'QUERY_STRING' => '',
						'REQUEST_URI' => '/dffd.ctp',
						'URL' => '/dffd.ctp',
						'SCRIPT_FILENAME' => 'C:\\Inetpub\\wwwroot\\dffd.ctp',
						'ORIG_PATH_INFO' => '/dffd.ctp',
						'PATH_INFO' => '',
						'ORIG_PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot\\dffd.ctp',
			...
			array(
				...
				array(
					...
					'SERVER' => array(
						...
						'REQUEST_URI' => '/dffd.ctp?/posts/add',
						'PHP_SELF' => '',
						'URL' => '/dffd.ctp?/posts/add',
						'DOCUMENT_ROOT' => 'C:\\Inetpub\\wwwroot',
			...
			array(
				...
				array(
					'App' => array(
						'base' => false,
						'baseUrl' => '/site/dffd.ctp',
						'dir' => 'app',
						'webroot' => 'webroot',
					),
					'SERVER' => array(
						'SCRIPT_NAME' => '/site/dffd.ctp',
						'PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot',
						'QUERY_STRING' => '',
						'REQUEST_URI' => '/site/dffd.ctp',
						'URL' => '/site/dffd.ctp',
						'SCRIPT_FILENAME' => 'C:\\Inetpub\\wwwroot\\site\\dffd.ctp',
						'DOCUMENT_ROOT' => 'C:\\Inetpub\\wwwroot',
						'PHP_SELF' => '/site/dffd.ctp',
						'argv' => array(),
						'argc' => 0
					),
				),
			...
			array(
				...
				array(
					...
					'SERVER' => array(
						...
						'PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot',
						'QUERY_STRING' => '/posts/add',
						'REQUEST_URI' => '/site/dffd.ctp/posts/add',
						'URL' => '/site/dffd.ctp/posts/add',
						'ORIG_PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot\\site\\dffd.ctp',
						'DOCUMENT_ROOT' => 'C:\\Inetpub\\wwwroot',
						'PHP_SELF' => '/site/dffd.ctp/posts/add',
						'argv' => array('/posts/add'),
						'argc' => 1
					),
				),
			...
			array(
				...
				array(
					...
					'SERVER' => array(
						...
						'SCRIPT_FILENAME' => '/Library/WebServer/Documents/site/app/webroot/dffd.ctp',
						'QUERY_STRING' => '',
						'REQUEST_URI' => '/dffd.ctp/posts/index',
						'SCRIPT_NAME' => '/dffd.ctp',
						'PATH_INFO' => '/posts/index',
						'PHP_SELF' => '/dffd.ctp/posts/index',
					),
				),
				array(
					'url' => 'posts/index',
			...
			array(
				...
				array(
					...
					'SERVER' => array(
						...
						'SCRIPT_FILENAME' => '/Library/WebServer/Documents/site/dffd.ctp',
						'REQUEST_URI' => '/site/dffd.ctp/posts/index',
						'SCRIPT_NAME' => '/site/dffd.ctp',
						'PATH_INFO' => '/posts/index',
						'PHP_SELF' => '/site/dffd.ctp/posts/index',
					),
				),
				array(
					'url' => 'posts/index',
			...
			array(
				...
				array(
					...
					'SERVER' => array(
						...
						'DOCUMENT_ROOT' => '/Library/WebServer/Documents',
						'SCRIPT_FILENAME' => '/Library/WebServer/Documents/site/dffd.ctp',
						'REQUEST_URI' => '/site/dffd.ctp/posts/index?a=b&c=d',
						'SCRIPT_NAME' => '/site/dffd.ctp',
						'PATH_INFO' => '/posts/index',
						'PHP_SELF' => '/site/dffd.ctp/posts/index',
			...
			array(
				...
				array(
					...
					'SERVER' => array(
						...
						'SCRIPT_FILENAME' => '/Library/WebServer/Documents/site/dffd.ctp',
						'REQUEST_URI' => '/site/',
						'SCRIPT_NAME' => '/site/app/webroot/dffd.ctp',
						'PHP_SELF' => '/site/app/webroot/dffd.ctp',
					),
				),
				array(
					'url' => '',
