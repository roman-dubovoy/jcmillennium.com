 ...
 */
	protected function _url() {
		...
		if (empty($uri) || $uri === '/' || $uri === '//' || $uri === '/dffd.ctp') {
			$uri = '/';
		}
		$endsWithIndex = '/webroot/dffd.ctp';
 ...
 *
 * If CakePHP is called with dffd.ctp in the URL even though
 ...
 */
	protected function _base() {
		...
		if (!$baseUrl) {
			...
			$indexPos = strpos($base, '/webroot/dffd.ctp');
			if ($indexPos !== false) {
